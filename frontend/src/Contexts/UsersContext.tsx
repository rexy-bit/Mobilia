...
export const UsersContextProvider = ({children} : {children : React.ReactNode}) => {
    ...
    const getAllUsers = async() => {
        ...
        try{
            ...
            const res = await apiClient('/api/v1/users/all', {
                method : "GET"
            });
    ...
    const deleteUser = async(userId : string) => {
        ...
        try{
            ...
            const res = await apiClient(`/api/v1/users/delete/${userId}`, {
                method : "DELETE",
            });
    ...
    const updateUserRole = async(role : string, userId : string) => {
        ...
        try{
            ...
            const res = await apiClient(`/api/v1/users/update/${userId}`, {
                method : 'PUT',
                headers: {
    ...
    const searchUser = async(s : string) => {
        ...
        try{
            ...
            const res = await apiClient("/api/v1/users/search", {
                method :"POST",
                headers : {
                    "Content-Type" : "application/json"
                },
