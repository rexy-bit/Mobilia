...
export const RequestProvider = ({children} : {children : React.ReactNode}) => {
    ...
    const getAllRequests = async() => {
        ...
        try{
            const res = await apiClient("/api/v1/requests/", {
                method : "GET"
            });
    ...
    const updateRequestStatus = async(status : string, requestId : string)=>{
        ...
        try{
            const res = await apiClient(`/api/v1/requests/${requestId}`, {
                method : "PUT",
                headers : {
                    "Content-Type" : "application/json",
    ...
    const searchRequest = async(search : string) => {
        ...
        try{
            ...
            const res = await apiClient("/api/v1/requests/search", {
                method : "POST",
                headers : {
                    "Content-Type" : "application/json"
                },
    ...
    const getuncheckeRequests = async() => {
        ...
        try{
        const res = await apiClient("/api/v1/requests/unChecked", {
            method : "GET"
        });
